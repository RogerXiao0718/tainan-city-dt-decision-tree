    ...
    >
      ...
      <div className={`${styles["conditions-container"]}`}>
        <div className={`${styles["condition-row"]}`}>
          <label>相關機關: </label>
          <select
            className={`${styles["condition-select"]}`}
            onChange={onDepartmentSelectChange}
            value={stringArrayFilterRule["departments"]}
          >
        ...
        <div className={`${styles["condition-row"]}`}>
          ...
          <select
            className={`${styles["condition-select"]}`}
            onChange={onDomainSelectChange}
            value={stringArrayFilterRule["domain"]}
          >
              ...
              {pair.map((decisionName) => {
                return (
                  <>
                    ...
                    <ToggleButton
                      callback={ToggleButtonCallbackGenerator(
                        decisionName,
                        setFilterRule
                      )}
                      toggled={filterRule[decisionName]}
                    />
                  </>
                );
              })}
